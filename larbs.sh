...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/denisalevi/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/denisalevi/LARBS/master/progs.csv"
